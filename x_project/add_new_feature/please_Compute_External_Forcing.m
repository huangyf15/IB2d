...
function [Fx, Fy, first, inds] = please_Compute_External_Forcing(~,current_time,x,y, grid_Info, uX, uY, first, inds)
...
uX_Tar = Umax * tanh(1000*t);    % Only external forces in x-direction
