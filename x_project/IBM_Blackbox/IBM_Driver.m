...
while current_time < T_FINAL
    ...
    if ( ( update_Target_Pts == 1 ) && ( target_pts_Yes == 1) )
       target_info = update_Target_Point_Positions(dt,current_time,target_info,xLag_P,yLag_P,xLag,yLag,xLag_h,yLag_h,F_Lag);
    end
    ...
    if ( ( mod(cter,pDump) == 0  ) && ( cter >= pDump ) )
        ...
        %Print Current Time
        fprintf('Current Time(s): %6.6f\n',current_time);
        print_Current_State(current_time,xLag,yLag,F_Lag);
